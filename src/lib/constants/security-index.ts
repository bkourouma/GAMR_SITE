export const SECURITY_INDEX_DATA = {
  ...
  methodology: {
    ...
    overview:
      "La «Grille d'Analyse des Menaces et Risques» (GAMR) est une méthodologie simplifiée et un outil pratique axé sur les facteurs de risques de l'entreprise (structure, outil de production et personnel), pour aider à l'exécution d'une Evaluation de Sécurité.",
    disclaimer:
      "Important : La GAMR doit être mise à jour aussi souvent que l'évolution des circonstances peut l'exiger afin de maintenir son efficacité.",
  },
  scoreIndicators: [
    {
      id: 'low-risk',
  ...
  processSteps: [
    ...
    },
    {
      ...
      examples: [
        ...
        'Scénario le plus faible: 1 × 1 × 3 = 3',
      ],
    },
    {
      id: 'action-priority',
