...
export const metadata: Metadata = {
  title: 'Essai Gratuit GAMRdigitale - Démarrez en 2 Minutes',
  description:
    'Configurez votre essai gratuit GAMRdigitale en 10 questions. Sans CB, résiliable, support inclus. Gestion des risques et conformité.',
  robots: 'index, follow',
  openGraph: {
    title: 'Essai Gratuit GAMRdigitale - Démarrez en 2 Minutes',
    description:
