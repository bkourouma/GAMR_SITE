...
/**
 * Solutions Page - Demonstrates how GAMR adapts to 5 key industry sectors
...
export default function SolutionsPage() {
  return (
    <main>
      ...
      <IntroSection content="Chaque secteur fait face à des risques spécifiques, encadrés par des normes strictes. GAMR s'adapte à vos cadres réglementaires pour simplifier la conformité et accélérer la prise de décision." />
